		...
		<div id="layoutSidenav_content" style="padding-left: 0px;">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">Error Code Table</h1>
					<div class="card mb-4">
						<div class="card-body">Error code search function</div>
					</div>
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table me-1"></i> Error Code
						</div>
						<div class="card-body">
							<table id="datatablesSimple">
								...
								<tbody>
									...
									<tr>
										...
										<td>Measuring environment error</td>>
									</tr>
									<tr>
										<th>300
										</td>
